    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='user001', max_length=80)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_card', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='counteropt.online_user')),
            ],
        ),
        migrations.CreateModel(
            name='sys_manage',
