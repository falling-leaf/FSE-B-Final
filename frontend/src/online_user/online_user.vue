<template>
  ...
  mounted() {
    ...
    this.index = {
      ...
      personal:
        "/online_user/personal" + "?user_id=" + JSON.stringify(this.user_id),
      account:
        "/online_user/account" + "?user_id=" + JSON.stringify(this.user_id),
      record:
        "/online_user/record" + "?user_id=" + JSON.stringify(this.user_id),
    };
  },
};
</script>
